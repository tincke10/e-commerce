...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      <!-- cargo el componente de perfil de usuario -->
    ...
    <main class="app-content">
      ...
      <!-- invoco el script (ready.php) para que muestre el mensaje de carga exitosa -->
      <div id="mensaje"></div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <form method="post" action="carga.php">
              ...
              <input class="form-control mb-3" id="titulo" name="titulo" >
              <label for="descripcion">Descripción</label>
              <textarea class="form-control mb-3" id="descripcion" name="descripcion" rows="4" placeholder="Ingresa los detalles..."></textarea>
              <div class="form-check mb-3">
              <input class="form-check-input" type="radio" name="tipo_solicitud" value="1">
              <label class="form-check-label">Desarrollo de Nuevas funcionalidades</label>
              </div>
              <div class="form-check mb-3">
              <input class="form-check-input" type="radio" name="tipo_solicitud" value="2">
              <label class="form-check-label">Reporte de error</label>
              </div>
              <div class="form-check mb-3">
              <input class="form-check-input" type="radio" name="tipo_solicitud" value="3">
              <label class="form-check-label">Soporte Tecnico</label>
              </div>
...
$('form').on('submit', function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            console.log(response); // Añade esta línea
            if (response.includes('Por favor, rellena todos los campos.')) {
                // Carga obligatory.php en un elemento específico
                $('#mensaje').load('obligatory.php');
            } else if (response.includes('El título y la descripción deben contener al menos 5 caracteres cada uno.')) {
                // Carga complete.php en un elemento específico
                $('#mensaje').load('complete.php');
            } else {
                // Carga ready.php en un elemento específico
                $('#mensaje').load('ready.php?message=' + encodeURIComponent(response));
