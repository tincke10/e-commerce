    ...
    <section class="login-content">
      ...
      <div class="login-box ">
        <form class="login-form" action="auth.php" method="post">
          ...
          <!-- En caso de que sea invalidos los datos verifico si la alert ya se mostro -->
            <?php
            session_start();
            if (isset($_GET['error']) && $_GET['error'] == 'Invalid email or password' && !isset($_SESSION['shown_error'])) {
            $_SESSION['shown_error'] = true;
            ?>
           <!-- Verifico si el parametro error existe y si es igual a Invalid email or password -->
          <?php if (isset($_GET['error']) && $_GET['error'] == 'Invalid email or password'): ?>
        ...
        <?php endif; ?>
              <!-- Si ambas condiciones son true muestro el mensaje de error -->
          <?php
          } elseif (isset($_SESSION['shown_error'])) {
          unset($_SESSION['shown_error']);
          }
          ?>
          <!-- Si la alert se establecion en la sesion la elimino para que no se muestre mas -->
...
<!-- no es un requerimiento poder restablecer la contraseña -->
